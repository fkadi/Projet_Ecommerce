...
<html>
	...
	<body>
		<form  action="" method="post" enctype="multipart/form-data">
			...
			<table align="center" width="800" border="2" bgcolor="FF9900" >

				<tr align="center">
					<td colspan="7" bgcolor="FF9933"><h2>Inserer un nouveau produit</h2></td>
				</tr>
				...
				<tr>
					...
					<td><textarea name="product_desc" cols="50" rows="20" ></textarea></td>
				</tr>
				<tr>
...
//insertion des données dans la bd
	...
	if(isset($_POST['insert'])){
			...
			move_uploaded_file($product_image_tmp,"product_images/$product_image");
		     ...
		     echo $insert_product = "INSERT INTO Products (product_cat, product_title, product_brand, product_price, product_desc, product_keywords, product_image) VALUES('$product_cat', '$product_title', '$product_brand', '$product_price', '$product_desc', '$product_keywords', '$product_image')";
